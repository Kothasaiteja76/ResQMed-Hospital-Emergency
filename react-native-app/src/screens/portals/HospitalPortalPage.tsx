...
import { ChevronLeft, Building2, Siren, CalendarCheck2, Users, Activity } from 'lucide-react-native';
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={[styles.title, { color: colors.text }]}>Hospital Dashboard</Text>
          </View>
        </View>

        <View style={styles.grid}>
          <PortalCard icon={Siren} title="SOS Alerts" desc="Incoming emergencies" color="#ef4444" />
          <PortalCard icon={CalendarCheck2} title="Appointments" desc="Today's schedule" color="#06b6d4" />
          <PortalCard icon={Users} title="Doctors" desc="Manage staff" color="#10b981" />
          <PortalCard icon={Activity} title="Analytics" desc="Hospital stats" color="#8b5cf6" />
        </View>
...
const styles = StyleSheet.create({
  ...
  headerLabel: { fontSize: 10, fontWeight: '900', color: '#f59e0b', letterSpacing: 2 },
